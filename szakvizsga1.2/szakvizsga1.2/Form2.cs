...
namespace szakvizsga1._2
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand ruleparancs = new OleDbCommand();
            ruleparancs = new OleDbCommand("SELECT Role FROM Munkavallalok WHERE Username='" + textBox1.Text + "' AND Password='" + textBox2.Text + "'", kapcsolat);
            kapcsolat.Open();
            var role = ruleparancs.ExecuteScalar();
            if (role != DBNull.Value && role != null)
            {
                label4.Text = (string)role;
            }
            Role = label4.Text;
            kapcsolat.Close();
